...
class WithdrawalsController extends controller
{
    ...
    public function submit_withdrawal_request()
    {
        ...
        $method_details = $auth->company->iban_number;
        if ($method_details == null) {
            Session::putFlash('danger', "IBAN number does not exist. Please fill this on your profile");
            Redirect::back();
        }
