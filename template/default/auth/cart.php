...
<!--                                               <hr />
                                              <a href="javascript:void;" ng-click="$shop.$cart.empty_cart()"  class="btn btn-danger">Empty Cart</a>
                                              <a href="{{$shop.$links.shop}}" class="pull-right btn btn-dark"> Continue Shopping</a><br>
 -->                                                                  
                                        </div>
                                    </div>
                                </div>
