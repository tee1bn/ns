...
include 'includes/auth_header.php';?>
                ...
                <form data-toggle="validator"  class="form-horizontal form-material ajax_form" id="loginform" action="<?=domain;?>/forgot-password/send_link" method="post">
                    <h3 class="box-title mb-3">Reset Password</h3>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="email" required="" placeholder="Email" name="user"> </div>
                    </div>
