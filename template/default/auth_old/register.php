...
include 'includes/auth_header.php';?>
                ...
                <form data-toggle="validator"  class="form-horizontal form-material" id="loginform" action="<?=domain;?>/register/register" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary float-left pt-0">
                                ...
                                <label for="checkbox-signup"> 
                                    I have read the <a href="<?=domain;?>/w/terms">
